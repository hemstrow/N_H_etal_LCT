...
dat <- subset_snpR_data(dat, samps = which(!dat@sample.meta$ID %in% bads))
saveRDS(dat, "sib_purged_snpRdata.RDS")
...
ggsave("rf_pred_plot_sib_removal.pdf", prf1, "pdf", width = 11, height = 8.5)
...
#================save============
openxlsx::saveWorkbook(wb, "sib_removal_stats.xlsx", overwrite = T)
